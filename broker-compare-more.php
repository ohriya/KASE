...
<!-- hero banner ends -->
<section class="main-md">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card box-shadow-lg border-0 p-3">
                    <div class="section-header-sm text-left">
                        <h2 class="mb-4"> Comparison Results </h2>

                    </div>

                    <div class="">
                        <table class="table table-bordered number-table more-compare">
    
                            <thead>
                                <tr class="first-section">
                                    <th scope="col" class="p-0" width="25%"> </th>
                                    <th scope="col" class="p-0" width="20%">
                                        <div class="broker-compare-header">
                                            <img src="img/co-logo.png" class="img-fluid" alt="">
                                            <h4 class="compare-co-1 pt-3 pb-3"> Siprabi Securities Pvt. Ltd</h4>
                                    ...
                                    <th scope="col" class="p-0">
                                        <div class="broker-compare-header">
                                            ...
                                            <img src="img/co-logo2.png" class="img-fluid" alt="">
                                            <h4 class="compare-co-2 pt-3 pb-3">Secured Securities Ltd.</h4>
                                    ...
                                    <th scope="col" class="p-0">
                                        <div class="broker-compare-header">
                                            ...
                                            <img src="img/co-logo3.png" class="img-fluid" alt="">
                                            <h4 class="compare-co-2 pt-3 pb-3">ABC Securities Ltd.</h4>
                                    ...
                                    <th scope="col" class="p-0">
                                        <div class="broker-compare-header">
                                            ...
                                            <img src="img/co-logo4.png" class="img-fluid" alt="">
                                            <h4 class="compare-co-2 pt-3 pb-3">NAASA Securities Ltd.</h4>
                            ...
                            <tbody>
                                <tr>
                                    <th>D3 in 1 Account (MeroShare, TMS, Demat )</th>
                                    <td> <img src="img/tick-compare.svg" alt=""> </td>
                                    <td> <img src="img/tick-compare.svg" alt=""> </td>
                                    <td> <img src="img/tick-compare.svg" alt=""> </td>
                                    <td> <img src="img/tick-compare.svg" alt=""> </td>
                                ...
                                <tr>
                                    <th>Equity Cash Deposit Period (Days)</th>
                                    <td> <img src="img/tick-compare.svg" alt=""> </td>
                                    <td> <img src="img/cross-compare.svg" alt=""></td>
                                    <td> <img src="img/tick-compare.svg" alt=""></td>
                                    <td> <img src="img/tick-compare.svg" alt=""></td>
