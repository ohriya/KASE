...
<!-- hero banner starts -->
<section class="hero-banner mascot-subbanner compare-hero main-sm">

    <div class="shape-1">
        <svg xmlns="http://www.w3.org/2000/svg" width="171" height="301" viewBox="0 0 171 301">
            <g fill="#eff4fb" fill-rule="evenodd" opacity="1">
                <path d="M163.748 202.52L-17.825 310.89c-6.64 3.962-15.234 1.792-19.197-4.847A14 14 0 0 1-39 298.868V82.13c0-7.732 6.268-14 14-14a14 14 0 0 1 7.175 1.978l181.573 108.37c6.64 3.963 8.81 12.557 4.847 19.197a14 14 0 0 1-4.847 4.846z" />
                <path d="M113.748 92.52L-67.825 200.89c-6.64 3.962-15.234 1.792-19.197-4.847A14 14 0 0 1-89 188.868V-27.87c0-7.732 6.268-14 14-14a14 14 0 0 1 7.175 1.978l181.573 108.37c6.64 3.963 8.81 12.557 4.847 19.197a14 14 0 0 1-4.847 4.846z" />
            </g>
        </svg>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img src="img/tulke.svg" alt="tulke" class="img-fluid">
            </div>

            <div class="col-md-8">

                <div class="comaprison-wrapper">
                    <h4 class="text-green">Full details side by side</h4>
                    <h2 class="mb-3 ">broker comparison</h2>
                    <p class=" mb-3 ">"Find Your Perfect Broker"</p>
                    <p class=" mb-3 ">Compare brokers side-by-side on services, fees, and user ratings to find the best fit for your investment needs.</p>

                    <form action="" class="brand-form">
                        <div class="card box-shadow-lg float-box compare-box pe-2 ps-2 mt-2">
                            <div class="compare-1">
                            ...
                            <a href="./broker-compare-more.php" class="btn btn-brand btn-brand-primary"> <i class="fa fa-plus"> </i> Add more  </a>
                            
                        </div>

                        <div class="text-left mt-3">
                            <button type="submit" class="btn btn-brand btn-brand-primary"> Compare Now </button>
...
<section class="main bg-grey">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="section-header text-center">
                    <h2>Most Compared Brokers</h2>
                    <p> These are some comparisons to start with. Choose from the most compared brokers by Finology Select users.</p>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="card reset-card compare-card box-shadow-lg compare-card p-3">
                    <a href="broker-compare.php" class="divLink"> company </a>
                    <div class="row px-2">
                        <div class="col-md-5 col-12">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <img src="img/co-logo.png" class="img-fluid" alt="IND Super Saver FD" class="img-fluid FixedDeposit_cardLogo__uyiA4" />
                                </div>
                                <div class="col-md-9">
                                    <h3 class="mb-0 mt-1 mb-2">Nasa Securities Co. Ltd</h3>
                        ...
                        <div class="col-md-5 col-12">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <img src="img/co-logo2.png" class="img-fluid" alt="IND Super Saver FD" class="img-fluid FixedDeposit_cardLogo__uyiA4" />
                                </div>
                                <div class="col-md-9">
                                    <h3 class="mb-0 mt-1 mb-2">Secured Securities Co. Ltd</h3>
                                    <ul class="list-unstyled mb-0 d-flex star-group">
                                        <li>
                                            <img src="img/star.svg" alt="">
                                        </li>
                ...
                <div class="card reset-card compare-card box-shadow-lg compare-card p-3">
                    ...
                    <div class="row px-2">
                        <div class="col-md-5 col-12">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <img src="img/co-logo3.png" class="img-fluid" alt="IND Super Saver FD" class="img-fluid FixedDeposit_cardLogo__uyiA4" />
                                </div>
                                <div class="col-md-9">
                                    <h3 class="mb-0 mt-1 mb-2">ABC Securities Co. Ltd</h3>
                                    <ul class="list-unstyled mb-0 d-flex star-group">
                                        <li>
                                            <img src="img/star.svg" alt="">
                                        </li>
                        ...
                        <div class="col-md-5 col-12">
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    <img src="img/co-logo4.png" class="img-fluid" alt="IND Super Saver FD" class="img-fluid FixedDeposit_cardLogo__uyiA4" />
                                </div>
                                <div class="col-md-9">
                                    <h3 class="mb-0 mt-1 mb-2">Dynamic Co. Ltd</h3>
                                    <ul class="list-unstyled mb-0 d-flex star-group">
                                        <li>
                                            <img src="img/star.svg" alt="">
                                        </li>
