...
<p class=" display-6  text-center text-muted mb-5 text-capitalize">Forbidden ! You do not have access to this page</p>
<p class="text-center text-muted pb-1">Click refresh to load the page again</p>

<a href="#" class= "rounded-left m-auto btn btn-success text-center text-white text-capitalize justify-content-center d-flex align-items-center text-dark p-2 mb-1 w-25"> <span class="">refresh</span></a>

        </div>

        <div class="col-md-12 pt-5 d-flex justify-content-center">
        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="450" height="300"
            viewBox="0 0 672.5315 738.39398" xmlns:xlink="http://www.w3.org/1999/xlink">
            <path
                ...
                transform="translate(-263.73425 -80.80301)" fill="#35b14f" />
            <g opacity="0.1">
                <path
            ...
            <ellipse cx="597.86951" cy="515.08401" rx="4.76624" ry="4.8" transform="translate(-452.84172 492.81919) rotate(-45)"
                fill="#3f3d56" />
            <path
            ...
            <path
                ...
                transform="translate(-263.73425 -80.80301)" fill="#fff" />
            <path d="M529.73425,576.197a2.0001,2.0001,0,0,1-2-2v-118a2,2,0,0,1,4,0v118A2.0001,2.0001,0,0,1,529.73425,576.197Z"
            ...
            <path d="M499.73425,682.197a2.0001,2.0001,0,0,1-2-2v-86a2,2,0,1,1,4,0v86A2.0001,2.0001,0,0,1,499.73425,682.197Z"
                transform="translate(-263.73425 -80.80301)" fill="#ccc" />
            <path d="M576.73425,611.197a2.0001,2.0001,0,0,1-2-2v-118a2,2,0,1,1,4,0v118A2.0001,2.0001,0,0,1,576.73425,611.197Z"
                transform="translate(-263.73425 -80.80301)" fill="#ccc" />
            ...
            <path d="M618.73425,677.197a2.0001,2.0001,0,0,1-2-2v-86a2,2,0,1,1,4,0v86A2.0001,2.0001,0,0,1,618.73425,677.197Z"
                transform="translate(-263.73425 -80.80301)" fill="#ccc" />
            <path d="M626.73425,530.197a2.0001,2.0001,0,0,1-2-2v-118a2,2,0,1,1,4,0v118A2.0001,2.0001,0,0,1,626.73425,530.197Z"
                transform="translate(-263.73425 -80.80301)" fill="#ccc" />
