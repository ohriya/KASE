...
<!-- hero banner starts -->
<section class="hero-banner tms-subbanner main-sm">
    <svg xmlns="http://www.w3.org/2000/svg" width="1440" height="354" viewBox="0 0 1440 354">
        <defs>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="comaprison-wrapper">
                    <h4 class="text-green">Few Clicks</h4>
                    <h2 class="mb-3 ">Open Your TMS Accounts</h2>
                    <p class=" mb-3 ">"Start Trading Today"</p>
                    <p class=" mb-3 ">Open your TMS account quickly and easily, and access a world of trading opportunities.</p>

                        <form action="" class="">
                            <div class="card box-shadow-lg float-box">
                                <input type="text" class="form-control" placeholder="Search Broker">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="submit" class="btn btn-brand btn-brand-primary ms-3"> Search </button>
                                </div>
                            </div>
...
<section class="main-sm bg-grey">
    <div class="container">
        ...
        <div class="row gx-3 tms-companies">
            <div class="col-md-4">
                <div class="card widget-card box-shadow p-3">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="img-cont">
                        ...
                        <div class="col-md-9">
                            <h4 class="m-0 mb-0 card-title font-semibold">
                            Kumari Securities Pvt. Limited
                            </h4>
                            <ul class="list-unstyled mb-0 d-flex star-group mb-3">
                                <li>
                            ...
                            <div class="d-flex justify-content-between">
                                <p class="m-0 d-flex align-items-start text-green">
                            ...
                            <a href="" class="btn btn-brand-primary mt-3"> Visit Now </a>
                        </div>
            ...
            <!-- <div class="col-md-4">
                <div class="card widget-card box-shadow p-3">
                    ...
                    <a href="" class="btn btn-brand-secondary mt-2"> Visit Now </a>
                </div>
            </div> -->
